...
import com.example.ticketadmin.DashboardActivity;
...
public class AddBuss extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    ImageView back;
    EditText total_row, total_column, travels_name, bus_number, counter1_ticket_price, counter2_ticket_price, counter3_ticket_price;
    Button submit;
    Spinner busType;
    String date;
    ...
    private String creatingSeatPlan(int total_row, int total_col){
        seats="";
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.addBus){
            ...
            if(TextUtils.isEmpty(total_row.getText().toString()) ||TextUtils.isEmpty(total_column.getText().toString()) ||TextUtils.isEmpty(travels_name.getText().toString()) || TextUtils.isEmpty(bus_number.getText().toString()) || TextUtils.isEmpty(counter1_ticket_price.getText().toString())){
                ...
                tot_col = total_column.getText().toString();
                tot_seat = String.valueOf(Integer.parseInt(tot_row)*Integer.parseInt(tot_col));

                String seatPlan = creatingSeatPlan(Integer.parseInt(tot_row) , Integer.parseInt(tot_col));
