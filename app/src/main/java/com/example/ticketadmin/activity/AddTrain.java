...
public class AddTrain extends AppCompatActivity  implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    String tr_name, bogy_num, cou_1_tic_price, cou_2_tic_price="", cou_3_tic_price="", tot_row, tot_col;
    ...
    private List<String> creatingSeatPlan(int total_bugy, int total_row, int total_col){
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.addTrain){
            ...
            if(TextUtils.isEmpty(total_row.getText().toString()) ||TextUtils.isEmpty(total_column.getText().toString()) ||TextUtils.isEmpty(travels_name.getText().toString()) || TextUtils.isEmpty(bogy_number.getText().toString()) || TextUtils.isEmpty(counter1_ticket_price.getText().toString())){
                ...
                List<String> seatPlan = creatingSeatPlan(Integer.parseInt(bogy_num), Integer.parseInt(tot_row) , Integer.parseInt(tot_col));
